...
fn main() {
	...
	let face = facevar::Shape { x: face_x, y: face_y, color: face_color};
	...
	let left_nostril = facevar::Shape { x: left_nostril_x, y: left_nostril_y, color: left_nostril_color};
	...
	let right_nostril = facevar::Shape { x: right_nostril_x, y: right_nostril_y, color: right_nostril_color};
	...
	let lips = facevar::Shape { x: lips_x, y: lips_y, color: lips_color};
	...
	let teeth = facevar::Shape { x: teeth_x, y: teeth_y, color: teeth_color};
	...
	let left_brow = facevar::Shape { x: left_brow_x, y: left_brow_y, color: left_brow_color};
	...
	let right_brow = facevar::Shape { x: right_brow_x, y: right_brow_y, color: right_brow_color};
	...
	let left_white = facevar::Shape { x: left_white_x, y: left_white_y, color: left_white_color};
	...
	let right_white = facevar::Shape { x: right_white_x, y: right_white_y, color: right_white_color};
	...
	let left_iris = facevar::Shape { x: left_iris_x, y: left_iris_y, color: left_iris_color};
	...
	let right_iris = facevar::Shape { x: right_iris_x, y: right_iris_y, color: right_iris_color};
	...
	let left_pupil = facevar::Shape { x: left_pupil_x, y: left_pupil_y, color: left_pupil_color};
	...
	let right_pupil = facevar::Shape { x: right_pupil_x, y: right_pupil_y, color: right_pupil_color};
	...
	let hair = facevar::Shape { x: hair_x, y: hair_y, color: hair_color};
